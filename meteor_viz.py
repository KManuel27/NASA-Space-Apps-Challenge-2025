...
def simulate_sun_earth_asteroid(asteroid_obj=None):
        ...
        updatemenus=[dict(
            ...
            buttons=[
                dict(label="Play", method="animate", args=[
                    None, {"frame": {"duration": 50, "redraw": True}, "fromcurrent": True, "transition": {"duration": 0}}
                    ]),
    ...
    # --- Figure ---
    fig = go.Figure(
        data=[earth_marker, asteroid_marker, earth_traj, asteroid_traj, sun_sphere, sun_label, earth_label, asteroid_label],
